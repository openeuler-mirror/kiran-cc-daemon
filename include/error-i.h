...
extern "C"
{
    ...
    enum CCErrorCode
    {
        ...
        ERROR_ACCOUNTS_USER_UID_IN_SUBID_RANGE,
        ERROR_ACCOUNTS_USER_HOME_DIR_ALREADY_EXIST,

        // Groups
        ERROR_GROUPS_GROUP_NOT_FOUND_1 = 0x60000,
        ERROR_GROUPS_GROUP_NOT_FOUND_2,
        ERROR_GROUPS_GROUP_NOT_FOUND_3,
        ERROR_GROUPS_GROUP_NOT_FOUND_4,
        ERROR_GROUPS_GROUP_ALREADY_EXIST,

        ERROR_GROUPS_SPAWN_SYNC_FAILED = 0x60100,
        ERROR_GROUPS_SPAWN_EXIT_STATUS,

        // Groups Group (Command Error)
        ERROR_GROUPS_GROUP_COMMAND_USAGE = 0x60200,
        ERROR_GROUPS_GROUP_COMMAND_BAD_ARG,
        ERROR_GROUPS_GROUP_COMMAND_GID_IN_USE,
        ERROR_GROUPS_GROUP_COMMAND_NOTFOUND,
        ERROR_GROUPS_GROUP_COMMAND_PRIMARY_GROUP,
        ERROR_GROUPS_GROUP_COMMAND_NAME_IN_USE,
        ERROR_GROUPS_GROUP_COMMAND_GRP_UPDATE,
        ERROR_GROUPS_GROUP_COMMAND_CLEANUP_SERVICE,
        ERROR_GROUPS_GROUP_COMMAND_PAM_USERNAME,
        ERROR_GROUPS_GROUP_COMMAND_PAM_ERROR,
        ERROR_GROUPS_GROUP_COMMAND_UNKNOWN,

        // Groups Group
        ERROR_GROUPS_GROUP_USER_NOT_EXIST = 0x60300,
        ERROR_GROUPS_GROUP_USER_ALREADY_IN_GROUP,
        ERROR_GROUPS_GROUP_USER_NOT_IN_GROUP,
        ...
        ERROR_APPEARANCE_CURSOR_SIZE_INVALID,
        ...
        ERROR_DISPLAY_ROTATION_NOT_SUPPORTED,
        ERROR_DISPLAY_REFLECT_NOT_SUPPORTED,
        ERROR_DISPLAY_NO_ENABLED_MONITOR,

        // Greeter
        ERROR_GREETER_SYNC_TO_FILE_FAILED = 0x190000,
        ...
        // Upgrade
        ERROR_UPGRADE_BACKEND_NOT_IDLE = 0x470000,
        ERROR_UPGRADE_SCAN_NOT_COMPLETED,
        ERROR_UPGRADE_SOLVE_DEPS_NOT_COMPLETED,
        ERROR_UPGRADE_INSTALL_NOT_COMPLETED,
        ERROR_UPGRADE_UPGRADE_PKGS_EMPTY,
        ERROR_UPGRADE_PACKAGE_IDS_EMPTY,
        ERROR_UPGRADE_REMINDER_INTERVAL_INVALID,
        ERROR_UPGRADE_HISTORY_DB_NOT_OPEN,
        ERROR_UPGRADE_HISTORY_DB_BROKEN,
    };
#ifdef __cplusplus
}
#endif
