...
//     timeout_handler_ = timeout.connect_seconds(sigc::mem_fun(this, &BackgroundCache::on_cache_clear_timeout), 120);
// }
...
//                                                       int32_t height)
// {
//     auto file_cache_info = get_file_cache_info(file_path);
...
//     auto file_cache_info = lookup_file_cache_info(file_absolute_path);
...
//         files_cache_.emplace(file_absolute_path, file_cache_info);
//     }
...
// {
//     auto iter = files_cache_.find(file_path);
//     RETURN_VAL_IF_TRUE(iter == files_cache_.end(), nullptr);
...
//     auto now = time(NULL);
//     for (auto iter = files_cache_.begin(); iter != files_cache_.end();)
//     {
//         if (iter->second->visit_time + BACKGROUND_CACHE_CLEAR_TIMEOUT_SECONDS < now)
//         {
//             files_cache_.erase(iter++);
//         }
//         else
//         {
//             ++iter;
...
//     auto file_cache_info = lookup_file_cache_info(file_path);
